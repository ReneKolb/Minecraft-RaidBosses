package de.GaMoFu.RaidBosses.Attributes;
...
public class Attributes {
    ...
    public enum Slot {
        ...
        public static Slot fromSlotName(String slotName) {
            // Linear scan is very fast for small N
            ...
            throw new IllegalArgumentException("Corrupt SlotName " + slotName + " detected.");
        }
    }
    ...
    public static class AttributeType {
        ...
        // new items, check if Sinnvoll
        public static final AttributeType GENERIC_ARMOR = new AttributeType("generic.armor").register();
        public static final AttributeType GENERIC_ARMOR_TOUGHNESS = new AttributeType("generic.armorToughness")
                .register();
        // Only for players
        public static final AttributeType PLAYER_ATTACK_SPEED = new AttributeType("generic.attackSpeed").register();
        public static final AttributeType PLAYER_LUCK = new AttributeType("generic.luck").register();
    ...
    public static class Attribute {
        ...
        public void setSlot(@Nonnull Slot slot) {
            if (slot == null)
                ...
                data.setString("Slot", slot.getSlotName());
        }
    ...
    public net.minecraft.server.v1_13_R1.ItemStack nmsStack;
