    ...
    public boolean handleCommand(RaidBosses plugin, CommandSender sender, Command command, String label,
        ...
        if (args.length >= 1 && args[0].equalsIgnoreCase("create")) {
            ...
            if (plugin.getWorlds().worldExists(worldName)) {
                sender.sendMessage("Cannot create '" + ChatColor.BLUE + worldName + ChatColor.RESET
            ...
            if (plugin.getWorlds().createWorld(worldName)) {
                ...
                sender.sendMessage(ChatColor.RED + "An error occured while creating world: '" + ChatColor.BLUE
            ...
            if (sender instanceof Player) {
                ...
                if (target == null) {
                    sender.sendMessage(
                            "No spawn location set for world '" + ChatColor.BLUE + worldName + ChatColor.RESET + "'");
            ...
            if (sender instanceof Player) {
                ...
                player.sendMessage("Set the the world's ('" + ChatColor.BLUE + world.getName() + ChatColor.RESET
                        + "') spawnpoint to " + spawnString);
            }
            return true;
